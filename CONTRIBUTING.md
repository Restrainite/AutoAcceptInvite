...
- Copy this command: `git clone https://github.com/Restrainite/AutoAcceptInvite.git`
...
- Back in file explorer, open the newly downloaded folder named AutoAcceptInvite. In that folder is yet another folder also named AutoAcceptInvite. Open that second folder.
